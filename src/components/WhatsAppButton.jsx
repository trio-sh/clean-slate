  ...
  return (
    <div className="fixed bottom-20 right-6 z-50 flex items-center gap-3">
      ...
      <motion.a
        ...
        className="flex items-center justify-center w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-lg transition-all duration-300 group relative"
        initial={{ scale: 0 }}
        animate={{ scale: 1 }}
